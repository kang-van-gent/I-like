                ...
                เช่าเว็บปั๊มไลค์แผงหลัก
                    ...
                    <li class="sidebar-item ">
                        <a class="sidebar-link-info {{ Request::is('buys*') ? 'active' : '' }}" href="/buys" aria-expanded="false">
                            ...
                            <span class="hide-menu">ตะกร้าสินค้า</span>
                        </a>
                    </li>
                    <!-- <li class="sidebar-item ">
                    ...
                    <li class="sidebar-item ">
                        <a class="sidebar-link-secondary " href="/faq" aria-expanded="false">
                            <span>
                    ...
                    <li class="sidebar-item ">
                        <a class="sidebar-link-secondary " href="/howitworks" aria-expanded="false">
                            <span>
                    ...
                    <li class="sidebar-item ">
                        <a class="sidebar-link-secondary " href="/tickets" aria-expanded="false">
                            <span>
