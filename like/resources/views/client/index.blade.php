  ...
  <div class="container">
    <div class="effect effect-tazza">
      ...
      <div class="effect-tazza-item-4">
        <div class="layer" data-depth=".4"><img class="lazy-img" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" data-src="images/image-39-639x439.png" alt="" width="639" height="439">
        </div>
      </div>
      <div class="effect-tazza-item-5">
        <div class="layer" data-depth=".5"><img class="lazy-img" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" data-src="images/image-38-1088x559.png" alt="" width="1088" height="559">
        </div>
      </div>
    </div>
  </div>
...
<!-- Users-->
<section class="section section-lg bg-invisible pended-element novi-background" data-preset='{"title":"Users","category":"counter, call to action","reload":true,"id":"users"}'>
  <div class="container">
    <div class="text-center" data-animate='{"class":"fadeInUp"}'>
      <h1>ผู้ใช้งานทั้งหมดของเรา <span class="text-primary"><span data-counter>21655</span>+</span></h1>
    </div>
  </div>
</section>
<section class="section section-lg bg-invisible novi-background" data-preset='{"title":"Blurb Ordered Sample","category":"blurb","reload":true,"id":"blurb-ordered-sample-1"}'>
  <div class="container">
