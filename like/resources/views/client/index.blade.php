  ...
  <div class="container">
    <div class="row row-30 align-items-lg-center justify-content-lg-between">
      <div class="col-lg-12" data-animate='{"class":"fadeInLeft"}'>
        ...
        <p>&emsp;&emsp;เรามีราคาที่ย่อมเยาที่สุดในตลาด เพื่อให้คุณสามารถเริ่มต้นธุรกิจเพิ่มยอดไลค์และสร้างรายได้ด้วยตัวเองได้อย่างง่ายดาย ทำงานได้สะดวก ทำได้ทุกที่ทุกเวลา โดยไม่ต้องลงทุนด้วยเงินก้อนใหญ่ และไม่มีความจำเป็นต้องสต๊อกสินค้า</p>
