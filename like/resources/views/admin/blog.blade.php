    ...
    <div>
      ...
      <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
        <ul id="sidebarnav">
          ...
          <li class="sidebar-item ">
            <a class="sidebar-link active" href="/blog" aria-expanded="false">
              <span>
        ...
        <div class="col-md-4">
          <div class="card overflow-hidden rounded-2">
            <div class="position-relative">
              <a href="/post"><img src="/src/assets/images/products/s11.jpg" href="/post" class="card-img-top rounded-0" alt="..."></a>

            </div>
            <div class="card-body pt-3 p-4">
              <h6 class="fw-semibold fs-4" href="/post">Cute Soft Teddybear</h6>
              <div class="d-flex align-items-center justify-content-between">
                <h6 class="fw-semibold fs-4 mb-0">$285 <span class="ms-2 fw-normal text-muted fs-3"><del>$345</del></span></h6>
              </div>
              <div class="d-grid gap-2 mt-3 col-6 mx-auto">
                <a class="btn btn-primary" type="button" href="/post">อ่านเพิ่มเติม</a>
