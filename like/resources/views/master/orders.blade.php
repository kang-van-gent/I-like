                <!-- Blogs -->
                <div class="col-12 isotope-item orders">
                                    ...
                                    <table class="table table-striped table-hover table-modern">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" style="min-width: 150px; width: 18.6%">ข้อมูลลูกค้า</th>
                                                ...
                                                <td>
                                                    <div class="row justify-content-center">
                                                        <div class="col-md-12 text-center">
                                                            <button type="button" class="btn btn-sm btn-primary mt-0" data-bs-toggle="modal" data-bs-target="#orderModal">
                                                                อ่าน
                                                            </button>
                                                            <button type="button" class="btn btn-sm btn-warning mt-0" data-bs-toggle="modal" data-bs-target="#orderModal">
                                                                แก้ไข
                                                            </button>
